...
class _AnimatedHitakuState extends State<AnimatedHitaku>
  ...
  Widget build(BuildContext context) {
    final w = widget.size;
    const assetPath = 'asset/images/home screen/Elegant figure with lavender accents.png';
...
class HeroMoonGlow extends StatelessWidget {
  ...
  const HeroMoonGlow({super.key, this.size = 180, this.pulse = 0});
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: RadialGradient(
          colors: [
            const Color(0xFFF5EEFF).withValues(alpha: 1.0), // brilliant bright core
            const Color(0xFFD8B4FE).withValues(alpha: 0.85 + pulse * 0.10),
            const Color(0xFF9D4EDD).withValues(alpha: 0.50 + pulse * 0.10),
            const Color(0xFF6B21C8).withValues(alpha: 0.20),
            Colors.transparent,
          ],
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFFC084FC).withValues(alpha: 0.55 + pulse * 0.20),
