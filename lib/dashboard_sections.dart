...
import '../figure_collection_service.dart';
import '../app_theme.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: Color(0xFFE8D5F5).withValues(alpha: 0.80),
          width: 1.0,
        ),
        boxShadow: [
          BoxShadow(
          ...
          BoxShadow(
            color: Color(0xFFEC4899).withValues(alpha: 0.04),
            blurRadius: 16,
            spreadRadius: 0,
            offset: Offset(0, 4),
          ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: AppTheme.terracotta.withValues(alpha: 0.55),
                      blurRadius: 6,
                      spreadRadius: 0.5,
                    ),
                  ],
...
class _PortalTile extends StatelessWidget {
  ...
  _PortalTile({required this.item});
    ...
    return _PressScale(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppTheme.surfaceRaised.withValues(alpha: 0.86)),
          boxShadow: [
            BoxShadow(
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(item.icon, size: 16, color: AppTheme.surfaceRaised),
                ),
                const Spacer(),
                Text(
                  item.title,
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Color(0xFF4C1D95).withValues(alpha: 0.40),
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Colors.transparent,
                      AppTheme.terracotta.withValues(alpha: 0.60),
                      Colors.transparent,
                    ],
                  ),
                ),
                  ...
                  children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            shape: BoxShape.circle,
                            boxShadow: [BoxShadow(color: AppTheme.terracotta.withValues(alpha: 0.6), blurRadius: 6, spreadRadius: 1)],
                          ),
                        ),
                        SizedBox(width: 5),
                        Text(
                          'UNIVERSE HIGHLIGHT',
                          style: TextStyle(
                            color: AppTheme.surfaceRaised.withValues(alpha: 0.80),
                            fontSize: 9,
                            fontWeight: FontWeight.w900,
                            letterSpacing: 1.5,
                          ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppTheme.terracotta.withValues(alpha: 0.55), width: 0.8),
                      ),
                      child: const Text(
                        'EPISODE BARU',
                        style: TextStyle(color: AppTheme.surfaceRaised, fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 0.8),
                      ),
                    ),
                    ...
                    Text(
                      'The system awakens.',
                      style: TextStyle(
                        color: AppTheme.surfaceRaised.withValues(alpha: 0.60),
                        fontSize: 11,
                      ...
                      children: [
                        ...List.generate(3, (i) => Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color: [AppTheme.sage, const Color(0xFFFF4FA3), const Color(0xFF3B82F6)][i],
                              border: Border.all(color: AppTheme.surfaceRaised, width: 1.5),
                            ),
                            child: Center(
                              child: Text(
                                ['S', 'A', 'K'][i],
                                style: const TextStyle(fontSize: 8, color: AppTheme.surfaceRaised, fontWeight: FontWeight.w900),
                              ),
                            ),
                          ),
                        )),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: AppTheme.surfaceRaised.withValues(alpha: 0.55),
                            fontSize: 9,
                    ...
                    _PressScale(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [AppTheme.terracotta, Color(0xFFBF55EC)],
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: AppTheme.terracotta.withValues(alpha: 0.50),
                              blurRadius: 16,
                              spreadRadius: 1,
                              offset: Offset(0, 4),
                            ),
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            child: const Row(
                              ...
                              children: [
                                Icon(Icons.play_arrow_rounded, color: AppTheme.surfaceRaised, size: 18),
                                SizedBox(width: 6),
                                Text(
                                  'Tonton Sekarang',
                                  style: TextStyle(
                    ...
                    Row(
                      ...
                      children: List.generate(5, (i) => Container(
                        ...
                        decoration: BoxDecoration(
                          color: i == 0
                              ? AppTheme.terracotta
                              : AppTheme.surfaceRaised.withValues(alpha: 0.35),
                          borderRadius: BorderRadius.circular(3),
                          boxShadow: i == 0 ? [
                            BoxShadow(color: AppTheme.terracotta.withValues(alpha: 0.6), blurRadius: 6, spreadRadius: 1),
                          ] : null,
                        ),
                      )),
                    ),
...
class EventCardSection extends StatelessWidget {
          ...
          children: [
            ...
            Positioned.fill(
              child: Image.asset(
                ...
                fit: BoxFit.cover,
                alignment: Alignment.center,
                errorBuilder: (_, __, ___) => Container(color: Color(0xFFFDE8F3)),
              ),
            ),
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: AppTheme.surfaceRaised.withValues(alpha: 0.5), width: 0.8),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: const [
                            Icon(Icons.star_rounded, color: AppTheme.surfaceRaised, size: 8),
                            SizedBox(width: 2),
                            Text(
                              'PREMIUM PASS',
                              style: TextStyle(
                  ...
                  Row(
                    children: [
                      ...
                      _buildTrackLine(),
                      _buildTrackCircle(
                        child: Icon(Icons.diamond_rounded, color: Color(0xFFEC4899), size: 12),
                      ),
                      _buildTrackLine(),
                      _buildTrackCircle(
                        color: AppTheme.surfaceRaised.withValues(alpha: 0.8),
            ...
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Color(0xFFE25B9A).withValues(alpha: 0.3),
                      blurRadius: 8,
                    ...
                    child: const Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 3),
                          Icon(Icons.keyboard_double_arrow_right_rounded, color: AppTheme.surfaceRaised, size: 10),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget _buildTrackCircle({required Widget child, Color? color}) {
    return Container(
      ...
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        color: color ?? AppTheme.surfaceRaised.withValues(alpha: 0.65),
        border: Border.all(color: AppTheme.surfaceRaised, width: 1.0),
        boxShadow: [
          BoxShadow(
...
class _StarfieldPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()..color = AppTheme.surfaceRaised..style = PaintingStyle.fill;
    final rng = math.Random(99);
    for (int i = 0; i < 25; i++) {
      final x = rng.nextDouble() * size.width;
      final y = rng.nextDouble() * size.height;
      final r = 0.5 + rng.nextDouble() * 1.2;
      paint.color = AppTheme.surfaceRaised.withValues(alpha: 0.15 + rng.nextDouble() * 0.35);
      canvas.drawCircle(Offset(x, y), r, paint);
    }
    // Pink sakura dots
    final pink = Paint()..color = Color(0xFFFF4FA3)..style = PaintingStyle.fill;
    for (int i = 0; i < 8; i++) {
      final x = rng.nextDouble() * size.width;
      final y = rng.nextDouble() * size.height * 0.6;
      pink.color = Color(0xFFFF4FA3).withValues(alpha: 0.12 + rng.nextDouble() * 0.18);
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        '+$_otherCount',
                        style: const TextStyle(color: AppTheme.surfaceRaised, fontSize: 10, fontWeight: FontWeight.w800),
                      ),
                    ),
                  ),
                ],
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _isHovered
                  ? Color(0xFFE25B9A).withValues(alpha: 0.6)
                  : AppTheme.surfaceRaised.withValues(alpha: 0.35),
              width: 0.8,
            ),
            boxShadow: [
              ...
              if (_isHovered)
                BoxShadow(
                  color: Color(0xFFE25B9A).withValues(alpha: 0.15),
                  blurRadius: 20,
                  spreadRadius: 2,
                ),
            ],
          ...
          child: ClipRRect(
            ...
            child: BackdropFilter(
              ...
              child: Container(
                color: AppTheme.surfaceRaised.withValues(alpha: 0.45),
                child: Stack(
                  children: [
                      ...
                      child: Opacity(
                        ...
                        child: Image.network(
                          ...
                          loadingBuilder: (context, child, progress) =>
                              progress == null ? child : ShimmerBox(),
                    ...
                    Positioned(
                      ...
                      child: AnimatedProgressBar(
                        ...
                        height: 4,
                        color: AppTheme.terracotta,
                        backgroundColor: AppTheme.surfaceRaised.withValues(alpha: 0.08),
                        borderRadius: BorderRadius.zero,
                        gradient: const LinearGradient(
                          colors: [AppTheme.sage, AppTheme.terracotta],
                        ),
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: AppTheme.terracotta.withValues(alpha: 0.18),
                                    borderRadius: BorderRadius.circular(5),
                                    border: Border.all(color: AppTheme.terracotta.withValues(alpha: 0.50)),
                                  ),
                                  child: Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                ...
                                Text(
                                  widget.subtitle,
                                  style: TextStyle(
                                    color: AppTheme.surfaceRaised.withValues(alpha: 0.65),
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600,
                                  ),
                                ),
                                ...
                                Row(
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        color: AppTheme.terracotta.withValues(alpha: 0.90),
                                        fontSize: 10,
                                ...
                                Row(
                                  children: [
                                            ...
                                            Positioned(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    ['S', 'A', 'K'][i],
                                                    style: TextStyle(fontSize: 5.5, color: AppTheme.surfaceRaised, fontWeight: FontWeight.w900),
                                                  ),
                                                ),
                                              ),
                                            ),
                                    ...
                                    Container(
                                      padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                      decoration: BoxDecoration(
                                        color: AppTheme.surfaceRaised.withValues(alpha: 0.12),
                                        borderRadius: BorderRadius.circular(4),
                                        border: Border.all(
                                          color: AppTheme.surfaceRaised.withValues(alpha: 0.20),
                                          width: 0.8,
                                        ),
                                      ),
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Icon(Icons.skip_next_rounded, color: AppTheme.surfaceRaised.withValues(alpha: 0.70), size: 10),
                                          SizedBox(width: 3),
                                          Text(
                                            'Next: EP 13',
                                            style: TextStyle(
                                              color: AppTheme.surfaceRaised.withValues(alpha: 0.90),
                                              fontSize: 8,
                                              fontWeight: FontWeight.w900,
                                            ),
                                          ),
                          ...
                          AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color: _isHovered ? AppTheme.terracotta : AppTheme.surfaceRaised.withValues(alpha: 0.20),
                              boxShadow: _isHovered
                                  ? [BoxShadow(color: AppTheme.terracotta.withValues(alpha: 0.5), blurRadius: 16, spreadRadius: 2)]
                                  : [],
                            ),
                            child: const Center(
                              child: Icon(Icons.play_arrow_rounded, color: AppTheme.surfaceRaised, size: 28),
                            ),
                          ),
                        ],
                      ),
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _isHovered
                    ...
                    : AppTheme.surfaceRaised.withValues(alpha: 0.08),
              ),
              boxShadow: [
                BoxShadow(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: AnimatedProgressBar(
                    ...
                    height: 3,
                    color: isDone ? Color(0xFF4ADE80) : _accentColor,
                    backgroundColor: AppTheme.surfaceRaised.withValues(alpha: 0.12),
                    borderRadius: BorderRadius.zero,
                  ),
                ),
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _isHovered
                ? Color(0xFF8B5CF6).withValues(alpha: 0.6)
                : AppTheme.surfaceRaised.withValues(alpha: 0.35),
            width: 0.8,
          ),
          boxShadow: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: AppTheme.sage.withValues(alpha: 0.40),
                                        blurRadius: 10,
                                      ),
                                    ],
                                  ),
                                      ...
                                      children: [
                                        Image.network(
                                          ...
                                          errorBuilder: (_, __, ___) => Container(
                                            ...
                                            child: Center(
                                              child: Icon(Icons.play_circle_fill_rounded, color: AppTheme.surfaceRaised, size: 28),
                                            ),
                                          ),
                                        ),
                                        Container(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: AnimatedProgressBar(
                                          ...
                                          height: 3,
                                          color: Color(0xFF8B5CF6),
                                          backgroundColor: Color(0xFF8B5CF6).withValues(alpha: 0.08),
                                          borderRadius: BorderRadius.circular(2),
                                        ),
                                      ),
                                    ],
                          ...
                          children: [
                              ...
                              child: _PressScale(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  icon: const Icon(Icons.meeting_room_rounded,
                                      color: AppTheme.surfaceRaised, size: 15),
                                  label: const Text(
                                    'Masuk Room',
                                    style: TextStyle(
                                      color: AppTheme.surfaceRaised,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10),
                                border: Border.all(
                                  color: Color(0xFF8B5CF6).withValues(alpha: 0.20),
                                ),
                              ),
                              child: IconButton(
                            ...
                            for (int i = 0; i < 3; i++)
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: AppTheme.surfaceRaised, width: 0.8),
                                ),
                              ),
                          ],
                        ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _ActivityCard(
          avatarChar: 'A',
          avatarColor: AppTheme.terracotta,
          ...
          if (eventLabel == 'BADGE BARU') ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(8),
                border: Border.all(color: AppTheme.terracotta.withValues(alpha: 0.4), width: 1),
              ),
              child: const Center(
                child: Icon(Icons.local_florist_rounded, color: AppTheme.terracotta, size: 16),
              ),
            ),
          ],
        ],
            ...
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(4),
                      border: Border.all(color: Color(0xFFFBBF24).withValues(alpha: 0.45)),
                    ),
                    child: Text(
                      'DAILY',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppTheme.sage.withValues(alpha: 0.25)),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.timer_rounded, color: AppTheme.sage, size: 9),
                    const SizedBox(width: 3),
                    const Text(
                      '14:18:24',
                      style: TextStyle(
          ...
          ...List.generate(_missions.length, (i) {
            ...
            return Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isDone
                      ? Color(0xFF4ADE80).withValues(alpha: 0.06)
                      : AppTheme.surfaceRaised.withValues(alpha: 0.65),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(
                    color: isDone
                        ? Color(0xFF4ADE80).withValues(alpha: 0.3)
                        : Color(0xFF8B5CF6).withValues(alpha: 0.08),
                  ),
                ),
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isDone
                            ? Color(0xFF4ADE80).withValues(alpha: 0.15)
                            : Color(0xFF8B5CF6).withValues(alpha: 0.05),
                        borderRadius: BorderRadius.circular(5),
                        border: Border.all(
                          color: isDone
                              ? Color(0xFF4ADE80)
                              : Color(0xFF8B5CF6).withValues(alpha: 0.20),
                          width: 1.5,
                        ),
                      ),
                      child: isDone
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              decorationColor: Color(0xFF7C7299).withValues(alpha: 0.5),
                            ),
                          ),
                          const SizedBox(height: 4),
                          Row(
                            children: [
                              ...
                              Row(
                                children: [
                                  const Icon(Icons.auto_awesome, color: AppTheme.sage, size: 8),
                                  const SizedBox(width: 2),
                                  Text(
                                    '+${m['xp']} XP',
                                    style: const TextStyle(
                    ...
                    if (!isDone)
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [Color(0xFF7C3AED), AppTheme.sage],
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            ),
              ...
              _TappableScale(
                ...
                child: Container(
                  ...
                  child: const Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.card_giftcard_rounded, color: AppTheme.surfaceRaised, size: 14),
                      SizedBox(width: 6),
                      Text(
                        'Klaim Semua Reward',
                        style: TextStyle(color: AppTheme.surfaceRaised, fontSize: 9, fontWeight: FontWeight.w900),
                      ),
                    ],
                  ),
                ),
...
class CollectionSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<FigureModel>>(
      valueListenable: FigureCollectionService.figuresNotifier,
      builder: (context, figures, _) {
        final owned = FigureCollectionService.ownedCount;
        final total = FigureCollectionService.totalCount;
        final progress = FigureCollectionService.progress;
        final featured = FigureCollectionService.featuredOwned;
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => _showFullCollection(context, figures),
                    child: const Text(
                      'Lihat Semua >',
              ...
              // Figure Collection label + real count
              const Text(
                'Figure Collection',
              ...
              // Featured figures row — top-rarity owned figures, real data
              GestureDetector(
                onTap: () => _showFullCollection(context, figures),
                child: SizedBox(
                  height: 90,
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(color: AppTheme.sage.withValues(alpha: 0.8), blurRadius: 8, spreadRadius: 2),
                            ],
                          ),
                        ),
                      ),
                      if (featured.isEmpty)
                        const Center(
                          child: Text(
                            'Belum ada figure yang terbuka',
                            style: TextStyle(color: Color(0xFF7C7299), fontSize: 9, fontWeight: FontWeight.w600),
                          ),
                        )
                      else
                        Row(
                          ...
                          children: [
                            for (int i = 0; i < featured.length; i++)
                              _buildChibiFigure(
                                featured[i].assetPath,
                                featured[i].glowColor,
                                i == 1 && featured.length == 3 ? 70 : 62,
                              ),
                          ],
                        ),
                    ],
              ...
              // 3D box icon — opens full collection grid
              const SizedBox(height: 8),
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [AppTheme.sage, Color(0xFF7C3AED)],
                        begin: Alignment.topLeft,
                        end: Alignment.bottomRight,
                      ),
                      borderRadius: BorderRadius.circular(8),
                      boxShadow: [BoxShadow(color: AppTheme.sage.withValues(alpha: 0.5), blurRadius: 8)],
                    ),
                    child: const Icon(Icons.view_in_ar_rounded, color: AppTheme.surfaceRaised, size: 16),
                  ),
                ),
              ),
            ],
  ...
  void _showFullCollection(BuildContext context, List<FigureModel> figures) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
      isScrollControlled: true,
      builder: (ctx) => _FullCollectionSheet(figures: figures),
    );
  }
...
// Grid of all figures (locked + unlocked) opened from "Lihat Semua" or the
// 3D box icon — genuinely reflects FigureCollectionService's dataset instead
// of just teasing a number with no way to see the rest.
class _FullCollectionSheet extends StatelessWidget {
  final List<FigureModel> figures;
  const _FullCollectionSheet({required this.figures});

  @override
  Widget build(BuildContext context) {
    final sorted = [...figures]
      ..sort((a, b) {
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text(
                      'Figure Collection',
                      style: TextStyle(color: Color(0xFF2C2543), fontSize: 16, fontWeight: FontWeight.w900),
                    ),
                    Text(
                      '${FigureCollectionService.ownedCount} / ${FigureCollectionService.totalCount}',
                      style: const TextStyle(color: Color(0xFFFF4FA3), fontSize: 13, fontWeight: FontWeight.w800),
                    ),
                  ],
                ),
              ),
              Expanded(
                child: GridView.builder(
                  ...
                  itemBuilder: (ctx, i) => _FigureGridTile(figure: sorted[i]),
                ),
              ),
            ],
          ),
...
class _FigureGridTile extends StatelessWidget {
  final FigureModel figure;
  const _FigureGridTile({required this.figure});

  @override
  Widget build(BuildContext context) {
    final color = figure.rarity.color;
    return Opacity(
      opacity: figure.owned ? 1.0 : 0.45,
      child: Container(
        decoration: BoxDecoration(
          color: Color(0xFFF7F4FF),
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: color.withValues(alpha: figure.owned ? 0.35 : 0.15)),
        ),
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  Image.asset(
                    ...
                    errorBuilder: (_, __, ___) => Icon(
                      figure.owned ? Icons.person_rounded : Icons.lock_rounded,
                      color: figure.owned ? color.withValues(alpha: 0.85) : Color(0xFFB3A9CC),
                      size: 30,
                    ),
                  ),
                  if (!figure.owned)
                    const Positioned(
                      bottom: 0,
                      right: 0,
                      child: Icon(Icons.lock_rounded, color: Color(0xFFB3A9CC), size: 14),
                    ),
                ],
              ),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                color: figure.owned ? const Color(0xFF2C2543) : const Color(0xFF9C93B5),
                fontSize: 8.5,
                fontWeight: FontWeight.w700,
              ),
            ),
        ...
        children: [
                  ...
                  children: [
                    RotationTransition(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(color: AppTheme.sage.withValues(alpha: 0.15), width: 1.5),
                        ),
                      ),
                    ),
          ...
          Wrap(
            ...
            children: [
              ...
              _buildTraitTag('STRATEGIST', Color(0xFF3B82F6)),
            ],
          ),
        ],
      ),
...
class _RadarChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final linePaint = Paint()
      ..color = AppTheme.surfaceRaised.withValues(alpha: 0.08)
      ..strokeWidth = 0.8
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [AppTheme.sage, Color(0xFF3B82F6)],
                    begin: Alignment.topCenter,
                    end: Alignment.bottomCenter,
                  ),
                  borderRadius: BorderRadius.circular(2),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  ...
                  BoxShadow(
                    color: Color(0xFF4C1D95).withValues(alpha: 0.40),
                    blurRadius: 50,
                    spreadRadius: 8,
                  ),
                ],
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(height: 1.5, color: AppTheme.surfaceRaised.withValues(alpha: 0.08)),
                  ),
                  // Equator line 2
                  Positioned(
                    top: 40, left: 0, right: 0,
                    child: Container(height: 1, color: AppTheme.surfaceRaised.withValues(alpha: 0.04)),
                  ),
                  // Ring shadow edge
                  Positioned.fill(
                    child: Container(
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(color: Color(0xFFE879F9).withValues(alpha: 0.15), width: 1),
                      ),
                    ),
                  ),
                ],
...
class _MiniSparklinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(dotCenter, 3.5,
        Paint()..color = color.withValues(alpha: 0.25)..maskFilter = MaskFilter.blur(BlurStyle.normal, 4));
    canvas.drawCircle(dotCenter, 2.0, Paint()..color = color..style = PaintingStyle.fill);
    canvas.drawCircle(dotCenter, 1.0, Paint()..color = AppTheme.surfaceRaised..style = PaintingStyle.fill);
  }
